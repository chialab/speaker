export const de = {
    ...
    voices: [
        ...
        },
        {
            ...
            nativeID: ['de-de-x-dea-network', 'de-de-x-dea-local'],
            language: 'de-DE',
            gender: 'female',
            quality: ['high'],
            rate: 1,
        ...
        },
        {
            ...
            nativeID: ['de-de-x-nfh-network', 'de-de-x-nfh-local'],
            language: 'de-DE',
            gender: 'female',
            quality: ['high'],
            rate: 1,
        ...
        },
        {
            ...
            nativeID: ['de-de-x-deb-network', 'de-de-x-deb-local'],
            language: 'de-DE',
            gender: 'male',
            quality: ['high'],
            rate: 1,
        ...
        },
        {
            ...
            nativeID: ['de-de-x-deg-network', 'de-de-x-deg-local'],
            language: 'de-DE',
            gender: 'male',
            quality: ['high'],
            rate: 1,
